...
model.load_state_dict(torch.load("cnn_patch_classifier.pth", map_location=torch.device('cpu')))
model.eval()
...
if __name__ == "__main__":
    input_image_path = "path_to_some_test_image.jpg"  # Replace with an actual test image path
    output_image_path = "output_clean_patches/output_clean_patches.jpg"  # Replace with your desired output path
    classify_and_reconstruct(input_image_path, output_image_path, patch_size=32)
